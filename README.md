...
The code asks the user for options to withdraw, deposit or check balance and according does all the calculations
...
![image](https://github.com/user-attachments/assets/3a90641e-c8b2-419e-aed3-111a0c5e8f98)
